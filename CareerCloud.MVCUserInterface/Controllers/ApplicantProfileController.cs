...
namespace CareerCloud.MVCUserInterface.Controllers
{
    public class ApplicantProfileController : Controller
    {
        ...
        {
            var applicantProfilePocoes = db.ApplicantProfilePocoes.Include(a => a.SecurityLogins).Include(a => a.SystemCountryCodes);
        ...
        {
            ViewBag.Login = new SelectList(db.SecurityLoginPocoes, "Id", "Login");
            ViewBag.Country = new SelectList(db.SystemCountryCodePocoes, "Code", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Login,CurrentSalary,CurrentRate,Currency,Country,Province,Street,City,PostalCode")] ApplicantProfilePoco applicantProfilePoco)
        {
            ...
            ViewBag.Login = new SelectList(db.SecurityLoginPocoes, "Id", "Login", applicantProfilePoco.Login);
            ViewBag.Country = new SelectList(db.SystemCountryCodePocoes, "Code", "Name", applicantProfilePoco.Country);
            return View(applicantProfilePoco);
        }
