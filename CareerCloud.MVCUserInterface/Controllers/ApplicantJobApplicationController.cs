...
namespace CareerCloud.MVCUserInterface.Controllers
{
    public class ApplicantJobApplicationController : Controller
    {
        ...
        {
            var applicantJobApplicationPocoes = db.ApplicantJobApplicationPocoes.Include(a => a.ApplicantProfiles).Include(a => a.CompanyJobs);
            return View(applicantJobApplicationPocoes.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Applicant,Job,ApplicationDate")] ApplicantJobApplicationPoco applicantJobApplicationPoco)
        {
            ...
            ViewBag.Applicant = new SelectList(db.ApplicantProfilePocoes, "Id", "Currency", applicantJobApplicationPoco.Applicant);
            ViewBag.Job = new SelectList(db.CompanyJobPocoes, "Id", "Id", applicantJobApplicationPoco.Job);
            return View(applicantJobApplicationPoco);
        }
